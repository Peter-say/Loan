                ...
                <div class="col-md-12 text-center">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">FHA Loan</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="services-details">
                        <div class="services-thumb-lg">
                            <img src="{{$web_assets}}/asset/img/loan/fha-loan.jpg" alt=""></a>
                        </div>
                        ...
                        <div class="single-sidebar">
                            <div class="services">
                                <ul>
                                    ...
                                    <li><a href="{{route('web.mortgage.')}}"><i class="fa fa-long-arrow-right"></i>Mortgage Loan</a></li>
