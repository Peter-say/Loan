            ...
            <div class="row">
                <div class="col-md-4 checkingbg1 text-center">
                    <div class="single-loan-checking-options">
                        <div class="icon">
                            <img src="{{$web_assets}}/asset/img/edom.png" alt="">
                        </div>
                        <div class="content">
                            <h4>No Hidden Fees</h4>
                            <p>A letters bas opposed to using content here
                                <br> english many desktop.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 checkingbg2 text-center">
                    <div class="single-loan-checking-options">
                        <div class="icon">
                            <img src="{{$web_assets}}/asset/img/document.png" alt="">
                        </div>
                        <div class="content">
                ...
                <div class="col-md-4 checkingbg3 text-center">
                    <div class="single-loan-checking-options">
                        <div class="icon">
                            <img src="{{$web_assets}}/asset/img/bripcase.png" alt="">
                        </div>
                        <div class="content">
            ...
            <div class="row process-list">
                <div class="col-md-3 second-process">
                    <div class="second-single-loan-process">
                        <h4>Choose Amount</h4>
                        <div class="icon">
                            <img src="{{$web_assets}}/asset/img/pade.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-3 second-process">
                    <div class="second-single-loan-process">
                        ...
                        <div class="icon">
                            <img src="{{$web_assets}}/asset/img/dollar.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-3 second-process">
                    <div class="second-single-loan-process">
                        <h4>Approved Loan</h4>
                        <div class="icon">
                            <img src="{{$web_assets}}/asset/img/handshake.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-md-3 second-process">
                    <div class="second-single-loan-process">
                        ...
                        <div class="icon">
                            <img src="{{$web_assets}}/asset/img/get-money.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="dream-quote-text">
                        <h4>Available but the major have embarrased</h4>
                        <h2>Make any dream a reality with one
                            <br>of our loan plans
                        </h2>
                        <a href="#" class="btn btn-default btn-sm">OUR SERVICES</a>
                    </div>
                </div>
            </div>
        </div>
